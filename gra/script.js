document.addEventListener('DOMContentLoaded', async () => {
    ...
    function addExample(classId) {
        ...
        if (features) {
            ...
            // saveModel(); // Zapis do Firebase usunięty dla uproszczenia
        } else {
    ...
    // Uproszczone funkcje, które usunęliśmy z HTML
    function saveModel() { console.log("Zapisywanie modelu - funkcja tymczasowo wyłączona."); }
    async function loadModel() { console.log("Wczytywanie modelu - funkcja tymczasowo wyłączona."); }
